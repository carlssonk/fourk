 ...
 */
export function prepareR0SuccinctWitness(receipt: HexString | Uint8Array): R0SuccinctWitnessParts;
/**
 * a borsh-encoded `Groth16Receipt<ReceiptClaim>` to the
 * compressed ark-groth16 proof bytes (hex), without touching a builder.
 */
export function prepareR0Groth16Proof(receipt: HexString | Uint8Array): HexString;
/**
...
*/
  toString(): string;
  free(): void;
  readonly sigScript: HexString;
  readonly redeemScript: HexString;
}
...
*/
  toString(): string;
  free(): void;
  readonly controlIndex: HexString;
  readonly controlDigests: HexString;
  readonly seal: HexString;
...
*/
   ...
   */
  static newR0(options?: ScriptBuilderOptions | null): ZkScriptBuilder;
  /**
   ...
   */
  finalizeWithGroth16Proof(receipt: HexString | Uint8Array, journal_hash: HexString | Uint8Array): FinalizedR0Script;
  /**
   ...
   * in order to unlock a ZK-locked UTXO the script is now ready.
   */
  finalizeWithSuccinctProof(receipt: HexString | Uint8Array, journal: HexString | Uint8Array): FinalizedR0Script;
  /**
   ...
   */
  commitToGroth16(image_id: HexString | Uint8Array): void;
  /**
   ...
   */
  pushR0Groth16Proof(receipt: HexString | Uint8Array): void;
  /**
   ...
   */
  pushR0SuccinctWitness(receipt: HexString | Uint8Array): void;
  /**
   ...
   */
  appendR0Groth16Verifier(image_id: HexString | Uint8Array): void;
  /**
   ...
   */
  appendR0SuccinctVerifier(image_id: HexString | Uint8Array, control_id: HexString | Uint8Array, hash_fn_id?: string | null): void;
  /**
   ...
   */
  appendR0Groth16VerifierWithFixedJournal(image_id: HexString | Uint8Array, journal_hash: HexString | Uint8Array): void;
  /**
   ...
   */
  appendR0SuccinctVerifierWithFixedJournal(image_id: HexString | Uint8Array, control_id: HexString | Uint8Array, hash_fn_id: string | null | undefined, journal: HexString | Uint8Array): void;
  /**
   ...
   */
  addData(data: HexString | Uint8Array): void;
  /**
   ...
   */
  commitToSuccinct(image_id: HexString | Uint8Array, control_id: HexString | Uint8Array, hash_fn_id?: string | null): void;
}
...
export interface InitOutput {
  ...
  readonly __wbg_zkscriptbuilder_free: (a: number, b: number) => void;
  readonly zkscriptbuilder_drain: (a: number) => number;
  readonly zkscriptbuilder_newR0: (a: number, b: number) => void;
  readonly zkscriptbuilder_script: (a: number) => number;
  readonly __wbg_r0succinctwitnessparts_free: (a: number, b: number) => void;
  readonly prepareR0Groth16Proof: (a: number, b: number) => void;
  readonly prepareR0SuccinctWitness: (a: number, b: number) => void;
  readonly r0succinctwitnessparts_claim: (a: number) => number;
  readonly r0succinctwitnessparts_controlDigests: (a: number) => number;
  readonly r0succinctwitnessparts_controlIndex: (a: number) => number;
  readonly r0succinctwitnessparts_seal: (a: number) => number;
  readonly zkscriptbuilder_addData: (a: number, b: number, c: number) => void;
  readonly zkscriptbuilder_appendR0Groth16Verifier: (a: number, b: number, c: number) => void;
  readonly zkscriptbuilder_appendR0Groth16VerifierWithFixedJournal: (a: number, b: number, c: number, d: number) => void;
  readonly zkscriptbuilder_appendR0SuccinctVerifier: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly zkscriptbuilder_appendR0SuccinctVerifierWithFixedJournal: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  readonly zkscriptbuilder_commitToGroth16: (a: number, b: number, c: number) => void;
  readonly zkscriptbuilder_finalizeWithGroth16Proof: (a: number, b: number, c: number, d: number) => void;
  readonly zkscriptbuilder_finalizeWithSuccinctProof: (a: number, b: number, c: number, d: number) => void;
  readonly zkscriptbuilder_pushR0Groth16Proof: (a: number, b: number, c: number) => void;
  readonly zkscriptbuilder_pushR0SuccinctWitness: (a: number, b: number, c: number) => void;
  readonly __wbg_finalizedr0script_free: (a: number, b: number) => void;
  readonly finalizedr0script_redeemScript: (a: number) => number;
  readonly finalizedr0script_sigScript: (a: number) => number;
  readonly zkscriptbuilder_commitToSuccinct: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
