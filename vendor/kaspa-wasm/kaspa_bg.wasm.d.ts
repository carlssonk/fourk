...
export const zkscriptbuilder_appendR0Groth16Verifier: (a: number, b: number, c: number) => void;
export const zkscriptbuilder_appendR0Groth16VerifierWithFixedJournal: (a: number, b: number, c: number, d: number) => void;
export const zkscriptbuilder_appendR0SuccinctVerifier: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
export const zkscriptbuilder_appendR0SuccinctVerifierWithFixedJournal: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
export const zkscriptbuilder_commitToGroth16: (a: number, b: number, c: number) => void;
export const zkscriptbuilder_finalizeWithGroth16Proof: (a: number, b: number, c: number, d: number) => void;
export const zkscriptbuilder_finalizeWithSuccinctProof: (a: number, b: number, c: number, d: number) => void;
export const zkscriptbuilder_pushR0Groth16Proof: (a: number, b: number, c: number) => void;
export const zkscriptbuilder_pushR0SuccinctWitness: (a: number, b: number, c: number) => void;
...
export const zkscriptbuilder_commitToSuccinct: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
